...
func NewMyTravelNotebookAPI(spec *loads.Document) *MyTravelNotebookAPI {
	return &MyTravelNotebookAPI{
		...
		TravelListTravelsHandler: travel.ListTravelsHandlerFunc(func(params travel.ListTravelsParams) middleware.Responder {
...
type MyTravelNotebookAPI struct {
	...
	// TravelListTravelsHandler sets the operation handler for the list travels operation
	TravelListTravelsHandler travel.ListTravelsHandler
...
func (o *MyTravelNotebookAPI) Validate() error {
	...
	if o.TravelListTravelsHandler == nil {
		unregistered = append(unregistered, "travel.ListTravelsHandler")
	}
...
func (o *MyTravelNotebookAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/travel/{travel_id}"] = travel.NewGetTravelByID(o.context, o.TravelGetTravelByIDHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/travels"] = travel.NewListTravels(o.context, o.TravelListTravelsHandler)
}
