...
func NewMyTravelNotebookAPI(spec *loads.Document) *MyTravelNotebookAPI {
	return &MyTravelNotebookAPI{
		...
		GetTravelHandler: GetTravelHandlerFunc(func(params GetTravelParams) middleware.Responder {
			return middleware.NotImplemented("operation GetTravel has not yet been implemented")
		}),
		...
		TravelUpdateTravelHandler: travel.UpdateTravelHandlerFunc(func(params travel.UpdateTravelParams) middleware.Responder {
			return middleware.NotImplemented("operation travel.UpdateTravel has not yet been implemented")
		}),
	}
}

/*MyTravelNotebookAPI MyTravelNotebook is an application aim to provide a simple way to create a booktrip.
 */
type MyTravelNotebookAPI struct {
	...
	// GetTravelHandler sets the operation handler for the get travel operation
	GetTravelHandler GetTravelHandler
	...
	// TravelUpdateTravelHandler sets the operation handler for the update travel operation
	TravelUpdateTravelHandler travel.UpdateTravelHandler
...
func (o *MyTravelNotebookAPI) Validate() error {
	...
	if o.GetTravelHandler == nil {
		unregistered = append(unregistered, "GetTravelHandler")
	}
	...
	if o.TravelUpdateTravelHandler == nil {
		unregistered = append(unregistered, "travel.UpdateTravelHandler")
	}
...
func (o *MyTravelNotebookAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/travel"] = NewGetTravel(o.context, o.GetTravelHandler)
	...
	o.handlers["PUT"]["/travel/{id}"] = travel.NewUpdateTravel(o.context, o.TravelUpdateTravelHandler)
}
